...
export function Cuestionario1() {
  ...
  //Funcion para continuar y manda listo
  const handleSubmit = (e) => {
    e.preventDefault()
    const newResponse = {...userData}
    newResponse.data[0] = sliderValue
    setUserData(newResponse)
    navigate('/cuestionario2');

  
  // Data to send in the POST request
 
  // URL of the API endpoint you want to send the POST request to
  // const apiUrl = 'http://localhost:5173/post_emotion_1';
  ...
  return (
    <form onSubmit={handleSubmit}
      ...
      <h1 className="font-bold text-4xl mb-4">Empecemos...</h1>
      <p className="mb-4">¿Qué tan activo te sientes hoy?</p>
      <input
        type="range"
        min="1"
        max="5"
      ...
      <p className="text-center mt-6">
        Entre mayor sea el número, más activo te sientes hoy: {sliderValue}
      </p>
      <button
        type="submit"
